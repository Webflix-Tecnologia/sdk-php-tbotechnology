...
namespace TboTechnology\Exceptions;
...
class TboTechnologyException extends Exception {
    ...
    public static function fromObjectMessage($message, $code, $previous = null){
        ...
        if(is_array($message)){
            ...
            return new TboTechnologyException( new Exception(implode("\n", $newMessageString), $code, $previous) );     
        }
        
        if(is_string($message)){
            
            return new TboTechnologyException( new Exception($message, $code, $previous) );     
    ...
    public static function fromGuzzleException(ServerException|ClientException|BadResponseException|RequestException $ex){
        ...
        return new TboTechnologyException( new \Exception($responseBody, $ex->getCode(), $ex->getPrevious()) );
    }
